...
Modify this page to display a card about each component. Components include:

* JAMstack - lessons learning using markup languages and static site generation
* Permaculture - component about sustainable living
* Writing - component about technical writing, fiction craft, non-fiction writing, and software tools
* Recipes - tasteful recipes for the Instant Pot pressure cooker, and more.
* The Survival List - items to have handy, should things go south
* Junk Drawer - Blog posts and assorted stuff I feel obliged to host somewhere.
    ...
    <div class="card-deck">
        <div class="card" onclick="location.href='../../site-home/latest/adoc-module/what-is-asciidoc.html';" style="cursor: pointer;">
            <img class="card-img-top img-fluid" src="../../site-home/latest/_images/web-design.png" alt="Card image cap">
              <div class="card-body">
                  ...
                  <p class="card-text">Lessons learned from using markup languages and static site generators.</p>
              </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Using permaculture, we can feed humans and wildlife, and restore the Earth's fertility and natural abundance.</p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Thoughts about the writing craft, and applying Scrivener to writing projects.</p>
                <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
            </div>
        </div>
    </div>
    ...
    <div class="card-deck">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Tasteful recipes for the Instant Pot pressure cooker, and more.</p>
                <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Essential items to have on hand, should things go south.</p>
                <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
            </div>
        </div>
        <div class="card">
