...
I created this site using https://antora.org[Antora^], the static site generator for xref:jamstack:asciidoc:about-asciidoc.adoc[AsciiDoc] files. See xref:jamstack:antora:why-antora-is-awesome.adoc[Antora is awesome].
