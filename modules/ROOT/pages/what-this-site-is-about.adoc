...
I created this site using https://antora.org[Antora^], the static site generator for xref:jamstack:asciidoc:what-is-asciidoc.adoc[AsciiDoc] files. See xref:antora-module:why-antora-is-awesome.adoc[Antora is awesome].
